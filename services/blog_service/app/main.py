...
async def create_article(
    ...
    return new_article
@app.post("/api/blog/articles/{article_id}/images", response_model=List[str])
async def upload_article_images(
    ...
    for file in files:
        ...
        saveed_filenames.append(unique_filename)
        
    await session.commit()
    return saveed_filenames